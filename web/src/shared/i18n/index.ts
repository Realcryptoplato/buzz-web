...
const messages = {
  ...
  "message.copyImageLink": { en: "Copy image link", "zh-CN": "复制图片链接" },
  ...
  "message.downloadImage": { en: "Save image", "zh-CN": "保存图片" },
  "message.expandImage": { en: "Expand image: {name}", "zh-CN": "展开图片：{name}" },
  "message.imageActionFailed": { en: "Image action failed", "zh-CN": "图片操作失败" },
  "message.imageFailed": { en: "Image failed to load", "zh-CN": "图片加载失败" },
  "message.imageLinkCopied": { en: "Image link copied", "zh-CN": "图片链接已复制" },
  "message.imageShareFallback": {
    en: "Sharing isn't available here. The image link was copied instead.",
    "zh-CN": "此处无法分享，已改为复制图片链接。",
  },
  "message.imageViewer": { en: "Image viewer", "zh-CN": "图片查看器" },
  ...
  "message.shareImage": { en: "Share image", "zh-CN": "分享图片" },
