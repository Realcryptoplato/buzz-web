...
const messages = {
  ...
  "activity.working": { en: "Working", "zh-CN": "工作中" },
  "activity.thinking": { en: "Thinking", "zh-CN": "思考中" },
  "activity.tool": { en: "Using a tool", "zh-CN": "使用工具" },
  "activity.responding": { en: "Responding", "zh-CN": "回复中" },
  "activity.quiet": { en: "Quiet", "zh-CN": "安静" },
  "activity.reconnecting": { en: "Reconnecting", "zh-CN": "正在重新连接" },
  "activity.disconnected": { en: "Disconnected", "zh-CN": "已断开" },
  "activity.unavailable": { en: "Activity unavailable", "zh-CN": "活动状态不可用" },
  "activity.unavailableDescription": {
    en: "Live agent activity is unavailable with this signer.",
    "zh-CN": "当前签名器无法提供 Agent 实时活动状态。",
  },
  "activity.waitingDescription": {
    en: "Waiting for live agent activity.",
    "zh-CN": "正在等待 Agent 实时活动。",
  },
  "activity.recent": { en: "Recent agent activity", "zh-CN": "最近的 Agent 活动" },
  "activity.view": { en: "View activity", "zh-CN": "查看活动" },
  "activity.panelTitle": { en: "Agent activity", "zh-CN": "Agent 活动" },
  "activity.viewMode": { en: "Activity view", "zh-CN": "活动视图" },
  "activity.compact": { en: "Activity", "zh-CN": "活动" },
  "activity.rawJson": { en: "JSON", "zh-CN": "JSON" },
  "activity.close": { en: "Close agent activity", "zh-CN": "关闭 Agent 活动" },
  "activity.resize": { en: "Resize agent activity", "zh-CN": "调整 Agent 活动面板宽度" },
  "activity.output": { en: "Output", "zh-CN": "输出" },
  "activity.showJson": { en: "Show JSON", "zh-CN": "显示 JSON" },
  "activity.hideJson": { en: "Hide JSON", "zh-CN": "隐藏 JSON" },
  "activity.jsonUnavailable": { en: "JSON unavailable", "zh-CN": "JSON 不可用" },
  "activity.empty": {
  ...
  "agents.closeProfile": { en: "Close agent profile", "zh-CN": "关闭 Agent 详情" },
  ...
  "agents.resize": { en: "Resize agent profile", "zh-CN": "调整 Agent 详情宽度" },
  ...
  "channel.backToBrowser": { en: "Back to channels", "zh-CN": "返回频道列表" },
  "channel.closeDetails": { en: "Close channel details", "zh-CN": "关闭频道详情" },
  "channel.details": { en: "Channel details", "zh-CN": "频道详情" },
  "channel.resizeDetails": { en: "Resize channel details", "zh-CN": "调整频道详情宽度" },
  ...
  "dm.choose": { en: "People and agents", "zh-CN": "成员与 Agent" },
  ...
  "inbox.resize": { en: "Resize Inbox list", "zh-CN": "调整 Inbox 列表宽度" },
  ...
  "workspace.tool.new-dm": { en: "New direct message", "zh-CN": "发起私聊" },
  "workspace.tool.repos": { en: "Projects", "zh-CN": "项目" },
  "workspace.tool.settings": { en: "Settings", "zh-CN": "设置" },
